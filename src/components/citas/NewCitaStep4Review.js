...
const NewCitaStep4Review = () => {
    ...
    return (
        ...
        <Grid container align='center' sx={{mt:6}}>
            <Grid item sx={3} xs={12}></Grid>
            <Grid item sx={6} xs={12}>
                <Typography variant='h5' align='center' sx={{ mt: 5, pl:5, pr:5, textTransform:'uppercase' }}>
                    <b>Tu cita se agendo correctamente <br/>
                    </b>
                </Typography>
            </Grid>
            <Grid item sx={3} xs={12}></Grid>
        ...
        <Grid container align='center' style={{ padding:'3px 15px'}}>
            <Grid item sx={4} xs={12}></Grid>
            <Grid item sx={4} xs={12}>
